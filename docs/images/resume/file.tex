...
Specifically interested in development using Python, Go, PHP, Java, MySQL, Javascript, Elixir and Rust Newbie!
...
\textbf{Specialties:} Python, Golang, PHP, Rust, Elixir, Java, Javascript, Typescript, PostgreSQL, MySQL, NoSQL, MongoDB, Cassandra, Redis, FastAPI, Gin, Django, Flask, Laravel, Symfony, Angular, VueJs, Vert.x, jQuery, LAMP, MVC, Kubernetes, Docker, Terraform, Ansible, Chef, Jenkins, Continuous Integration, AWS, GCP, Cloud Computing, DevOps, Grafana, Prometheus, ElasticSearch, Kafka, RabbitMQ, HAProxy, Vagrant, Consul, Nomad, Linux, Nginx, Bash, GIT, TDD, LangChain, LangGraph, RAG, embeddings, Qdrant, MCP, OpenRouter, vLLM.

\sepspace

\textbf{Current Interests:} Scaling Systems, Microservices Architecture, Cloud Native Architecture, High Availability, Automation, AI Powered Systems and Coding Agents.
...
\WorkEntry{Software Engineer}{Jan 2026 - Present}{HousingAnywhere, Rotterdam, Netherlands}{\begin{itemize}
\item Joined the Booking Experience team, Working on the Booking Platform.
\item Usage of AI to enhance the overall booking experience to drive more bookings and streamline the process
\item Using RESTful APIs and gRPC for service communication.
\item Working with Go, Python, Gin Framework, Fast API, PostgreSQL, Redis, Github and Jenkins, CI / CD
\item Deploying and managing services with Kubernetes on Google Cloud.
\end{itemize}}
\sepspace

\WorkEntry{Software Engineer}{Sep 2025 - Nov 2025}{Recorded Future, Amsterdam, Netherlands}{\begin{itemize}
...
\item Designed and operated the automation services of the Monitoring and Observability Platform for Cisco OpenDNS resolvers globally (Cisco Umbrella DNS).
\item Created automation tooling for monitoring systems (Naemon/Nagios, LGTM Stack, Grafana Cloud, Datadog) ensuring reliability, High Availability and GitOps-based change management.
\item Built chaos engineering service to assess any monitoring system efficiency and system resilience through random reboots, traffic drops, latency injection, and resource spikes.
\item Developed Scuti, an automated patching system for virtual servers supporting OS upgrades and custom scripts with sequential, batch, and percentage-based deployment strategies.
\item Built Oncall AI assistant to help Oncall engineers with automated troubleshooting and incident response.
