...
\item Building distributed systems and solving complex distributed problems.
\item Ensuring data quality and leveraging data insights for business decisions.
\item Working with Go, PostgreSQL and Redis for backend development.
\item Using RESTful APIs and gRPC for service communication.
\item Deploying and managing services with Docker and Kubernetes.
\end{itemize}}
\sepspace
